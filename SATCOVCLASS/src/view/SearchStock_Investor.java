...
public class SearchStock_Investor extends javax.swing.JFrame {

    User usr;
    public SearchStock_Investor(User usr, String search) throws Exception{
        this.usr = usr;
        
        initComponents();
        System.out.println(search);
        cari(search);
        /*DefaultTableModel tblModel = (DefaultTableModel)relevantStock.getModel();
        tblModel.setRowCount(0);
        relevantStock.getColumnModel().getColumn(0).setPreferredWidth(100);
        relevantStock.getColumnModel().getColumn(1).setPreferredWidth(508);
        relevantStock.getColumnModel().getColumn(2).setPreferredWidth(200);*/
    }
    ...
    private void initComponents() {
        ...
        relevantStock = new javax.swing.JTable();
        ...
        relevantStock.setBackground(new java.awt.Color(64, 64, 64));
        relevantStock.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        relevantStock.setForeground(new java.awt.Color(231, 231, 231));
        relevantStock.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        relevantStock.setGridColor(new java.awt.Color(64, 64, 64));
        relevantStock.setMaximumSize(new java.awt.Dimension(300, 64));
        relevantStock.setMinimumSize(new java.awt.Dimension(300, 64));
        relevantStock.setSelectionBackground(new java.awt.Color(231, 231, 231));
        relevantStock.setSelectionForeground(new java.awt.Color(80, 80, 80));
        relevantStock.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                relevantStockMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(relevantStock);
    ...
    private void relevantStockMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_relevantStockMouseClicked
        // TODO add your handling code here
        try {
            new SpecificStock_Investor(usr, relevantStock.getValueAt(relevantStock.getSelectedRow(), 1).toString()).setVisible(true);
            this.setVisible(false);
        } catch (Exception ex) {
            Logger.getLogger(Dashboard_Investor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_relevantStockMouseClicked
    
    void cari(String search)throws Exception{
        Connection con = Database.getConnection();              
        PreparedStatement p = con.prepareStatement("SELECT * FROM saham WHERE kode_saham LIKE '%"+search+"%' OR nama_saham LIKE '%"+search+"%';");
        ResultSet rs = p.executeQuery();
        DefaultTableModel tblModel = (DefaultTableModel)relevantStock.getModel();
        tblModel.setRowCount(0);
        while(rs.next()){
            String kodeSaham = rs.getString("kode_saham");
            String namaSaham = rs.getString("nama_saham");
            int hargaSaham = rs.getInt("harga_saham");
            String tbData[] = {kodeSaham, namaSaham, String.valueOf(hargaSaham)};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchStock_Investor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new SearchStock_Investor(usr, search).setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(SearchStock_Investor.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
    ...
    private javax.swing.JTable relevantStock;
