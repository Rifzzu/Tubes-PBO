...
public class BuyConfirmation_Investor extends javax.swing.JFrame {
    User usr;
    int harga, lot;
    int jumlah;
    String kodeSaham;
    public BuyConfirmation_Investor(User usr, String kodeSaham,int lot,int harga) throws Exception{
        this.usr = usr;
    ...
    private void initComponents() {
        ...
        buyButton.setBackground(new java.awt.Color(59, 150, 42));
        buyButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        buyButton.setForeground(new java.awt.Color(231, 231, 231));
        ...
        confFormLayout.setHorizontalGroup(
            ...
            .addGroup(confFormLayout.createSequentialGroup()
                .addGroup(confFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(confFormLayout.createSequentialGroup()
                        .addGap(112, 112, 112)
                        .addComponent(buyButton, javax.swing.GroupLayout.PREFERRED_SIZE, 123, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(confFormLayout.createSequentialGroup()
                        .addGap(22, 22, 22)
    ...
    private void buyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyButtonActionPerformed
        ...
        if(pwdInput.getText().equals("")){
            ...
            try {
                Investor.buyStock(usr.getUsername(), kodeSaham, lot);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuyConfirmation_Investor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new BuyConfirmation_Investor(usr,"",0,0).setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(BuyConfirmation_Investor.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
